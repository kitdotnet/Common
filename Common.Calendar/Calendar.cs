...
namespace Common.Calendar
{
    ...
    public class Calendar
    {
        ...
        {
            return GetInclusiveDays(start, finish).Count();
        }
        ...
        {
            return GetInclusiveDays(start, finish).Where(d => d.DayOfWeek != DayOfWeek.Saturday
        ...
        {
            return holiday.DayOfWeek == DayOfWeek.Saturday // move to Friday
                ? holiday.AddDays(-1)
