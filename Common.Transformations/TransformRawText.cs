...
namespace Common.Transformations
{
    ...
    public static class TransformRawText
    {
        ...
        /// <param name="maxRecursiveIternations">The maximum number of recursive iterations; present to prevent infinite loops.</param>
        /// <param name="currentIteration">The current iteration as related to <paramref name="maxRecursiveIternations"/>.</param>
        ...
        public static string Transform(string template,
            ...
            int maxRecursiveIternations = 100,
            int currentIteration = 0)
        {
            ...
            if (recursive && !templateCopy.Equals(template) && currentIteration < maxRecursiveIternations)
            {
                return Transform(template: templateCopy,
                    ...
                    maxRecursiveIternations: maxRecursiveIternations);
            }
